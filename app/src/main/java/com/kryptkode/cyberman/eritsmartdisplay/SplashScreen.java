...
public class SplashScreen extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Boolean>{
    ...
    private SettingReceiver mSTReceiver;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        wifiIntent =new IntentFilter("android.settings.action.MANAGE_WRITE_SETTINGS");
    ...
    private class SettingReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.settings.action.MANAGE_WRITE_SETTINGS")) {
